...
//    FILE *myout = fopen("output_log.txt", "wb+");
    ...
    do {
        ...
        switch (tagheader.TagType) {
            ...
            default: sprintf(tagtype_str, "UNKNOWN");
                break;
        }
        ...
        switch (tagheader.TagType) {
            ...
            default: fseek(ifh, reverse_bytes((byte *)&tagheader.DataSize, sizeof(tagheader.DataSize)), SEEK_CUR);
                break;
        }
        fprintf(myout, "\n");
    } while (!feof(ifh));
